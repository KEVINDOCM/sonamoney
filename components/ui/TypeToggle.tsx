    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`flex-1 h-10 py-0 text-sm font-medium border rounded-xl transition-[border-color,background-color,color,box-shadow] duration-200 active:scale-95 motion-reduce:transform-none ${value === "income"
        ...
        <button
          ...
          className={`flex-1 h-10 py-0 text-sm font-medium border rounded-xl transition-[border-color,background-color,color,box-shadow] duration-200 active:scale-95 motion-reduce:transform-none ${value === "expense"
